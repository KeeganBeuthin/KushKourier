...
const Slider = () => {
  return (
    <div className="border-bottom  pt-4 pb-4" style={{ height: 210 }}>
      ...
      <div
        className="container d-flex justify-content-between overflow-auto mx-auto pb-sm "
        style={{ height: 150 }}
      >
        {/* Category 1 (Hemp CBD) */}
        <div className="mx-sm" style={{ minWidth: "80px", width: "80px" }}>
          ...
          >
            <div
              className="rounded-circle overflow-hidden mb-lg"
        ...
        <div className="mx-sm" style={{ minWidth: "80px", width: "80px" }}>
          ...
          >
            ...
            <div className="text-success text-xs text-underline roboto">
              Flower
            </div>
          </a>
        </div>
